...
function(rapids_cpm_run_git_patch file issue)
  set(git_command C:/_/Git/bin/git.exe)
  ...
  if(result EQUAL 0)
    ...
    list(APPEND msg_state "rapids-cmake [CCCL]: failed to apply ${ext} ${file_name}")
    list(APPEND msg_state "rapids-cmake [CCCL]: git ${ext} output: ${repo_error_info}")
  endif()
...
set(files "D:/Reposity_github/CPlusPlus/Stdexec_Demo/build/_deps/rapids-cmake-src/rapids-cmake/cpm/patches/cccl/bug_fixes.diff;D:/Reposity_github/CPlusPlus/Stdexec_Demo/build/_deps/rapids-cmake-src/rapids-cmake/cpm/patches/cccl/hide_kernels.diff;D:/Reposity_github/CPlusPlus/Stdexec_Demo/build/_deps/rapids-cmake-src/rapids-cmake/cpm/patches/cccl/revert_pr_211.diff")
set(issues "CCCL installs header-search.cmake files in nondeterministic order and has a typo in checking target creation that leads to duplicates;Mark all cub and thrust kernels with hidden visibility [https://github.com/nvidia/cccl/pulls/443];thrust::copy introduced a change in behavior that causes failures with cudaErrorInvalidValue.")
set(output_file "D:/Reposity_github/CPlusPlus/Stdexec_Demo/build/rapids-cmake/patches/CCCL/log")
